...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-colors duration-300 ${scrolled ? 'bg-white/80 backdrop-blur shadow' : 'bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center">
            <Link to="/contact" className="ml-4 bg-amber-600 text-white px-4 py-2 rounded-md hover:bg-amber-700">Contact Us</Link>
          </div>
